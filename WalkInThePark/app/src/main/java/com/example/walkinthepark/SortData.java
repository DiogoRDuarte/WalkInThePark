...
public class SortData implements Comparator<HashMap<String, String>> {
    ...
    public int compare(HashMap<String, String> h1, HashMap<String, String> h2) {
        ...
        String[] p1 = d1.split("-");
        Date data1 = new Date(Integer.parseInt(p1[0]), Integer.parseInt(p1[1]), Integer.parseInt(p1[2]));

        String d2 = h2.get("data");
        String[] p2 = d1.split("-");
        Date data2 = new Date(Integer.parseInt(p2[0]), Integer.parseInt(p2[1]), Integer.parseInt(p2[2]));
